...
Future<void> main(List<String> rawArgs) async {
  ...
  AppLogger.runZoned(() async {
    ...
    if (kIsDesktop) {
      await localNotifier.setup(appName: "Extis");
      await WindowManagerTools.initialize();
    }

    if (kIsIOS) {
      HomeWidget.setAppGroupId("group.extis_home_player_widget");
    }
...
class Extis extends HookConsumerWidget {
  const Extis({super.key});
