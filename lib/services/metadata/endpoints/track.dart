...
class MetadataPluginTrackEndpoint {
  ...
  Future<ExtisFullTrackObject> getTrack(String id) async {
    final raw =
        await hetuMetadataTrack.invoke("getTrack", positionalArgs: [id]) as Map;

    return ExtisFullTrackObject.fromJson(
  ...
  Future<List<ExtisFullTrackObject>> radio(String id) async {
    ...
    return (result as List)
        .map(
          (e) => ExtisFullTrackObject.fromJson(
