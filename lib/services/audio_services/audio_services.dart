        ...
        ? await AudioService.init(
            ...
            config: AudioServiceConfig(
              androidNotificationChannelId: switch ((
                ...
                (true, _) => "extis",
                (_, ReleaseChannel.stable) => "oss.krtirtho.extis",
                (_, ReleaseChannel.nightly) => "oss.krtirtho.extis.nightly",
              },
              androidNotificationChannelName: 'Extis',
              androidNotificationOngoing: false,
              androidStopForegroundOnPause: false,
              androidNotificationChannelDescription: "Extis Media Controls",
            ),
          )
        : null;
