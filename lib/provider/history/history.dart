...
class PlaybackHistoryActions {
  ...
  Future<void> addPlaylists(List<ExtisSimplePlaylistObject> playlists) async {
  ...
  Future<void> addAlbums(List<ExtisSimpleAlbumObject> albums) async {
    await _batchInsertHistoryEntries([
  ...
  Future<void> addTracks(List<ExtisTrackObject> tracks) async {
    assert(
