...
typedef PlaybackHistoryAlbum = ({int count, ExtisSimpleAlbumObject album});
...
class HistoryTopAlbumsNotifier extends FamilyPaginatedAsyncNotifier<
  ...
  Selectable<ExtisSimpleAlbumObject> createAlbumsQuery(
    ...
    return database.customSelect(
      ...
      final album = ExtisSimpleAlbumObject.fromJson(jsonDecode(data));
      return album;
    });
  }
  ...
  List<PlaybackHistoryAlbum> getAlbumsWithCount(
    List<ExtisSimpleAlbumObject> albumsWithTrackAlbums,
  ) {
...
final historyTopAlbumsProvider = AsyncNotifierProviderFamily<
    ...
    ExtisPaginationResponseObject<PlaybackHistoryAlbum>,
    HistoryDuration>(
  () => HistoryTopAlbumsNotifier(),
);
