...
typedef PlaybackHistoryTrack = ({int count, ExtisTrackObject track});
typedef PlaybackHistoryArtist = ({int count, ExtisSimpleArtistObject artist});
...
class HistoryTopTracksNotifier extends FamilyPaginatedAsyncNotifier<
  ...
  fetch(offset, limit) async {
    ...
    return ExtisPaginationResponseObject<PlaybackHistoryTrack>(
      items: items,
  ...
  List<PlaybackHistoryArtist> getArtistsWithCount(
    Iterable<ExtisSimpleArtistObject> artists,
  ) {
...
final historyTopTracksProvider = AsyncNotifierProviderFamily<
    ...
    ExtisPaginationResponseObject<PlaybackHistoryTrack>,
    HistoryDuration>(
  () => HistoryTopTracksNotifier(),
);
