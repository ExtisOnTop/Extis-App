              ...
              try {
                ...
                event.onLoad((event) async {
                  await audioPlayerNotifier.load(
                    event.data.tracks.cast<ExtisFullTrackObject>().toList(),
                    autoPlay: true,
                  ...
                  if (event.data.collection is ExtisSimpleAlbumObject) {
                    historyNotifier.addAlbums(
                        [event.data.collection as ExtisSimpleAlbumObject]);
                  } else {
                    historyNotifier.addPlaylists(
                        [event.data.collection as ExtisSimplePlaylistObject]);
                  }
                });
