...
mixin PaginatedAsyncNotifierMixin<K>
    ...
    on AsyncNotifierBase<ExtisPaginationResponseObject<K>> {
  Future<ExtisPaginationResponseObject<K>> fetch(int offset, int limit);
...
abstract class PaginatedAsyncNotifier<K>
    extends AsyncNotifier<ExtisPaginationResponseObject<K>>
    with PaginatedAsyncNotifierMixin<K>, MetadataPluginMixin<K> {}

abstract class AutoDisposePaginatedAsyncNotifier<K>
    extends AutoDisposeAsyncNotifier<ExtisPaginationResponseObject<K>>
    with PaginatedAsyncNotifierMixin<K>, MetadataPluginMixin<K> {}
