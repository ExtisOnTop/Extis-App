...
class MetadataPluginSavedAlbumNotifier
    extends PaginatedAsyncNotifier<ExtisSimpleAlbumObject> {
  @override
  ...
  Future<void> addFavorite(List<ExtisSimpleAlbumObject> albums) async {
  ...
  Future<void> removeFavorite(List<ExtisSimpleAlbumObject> albums) async {
    if (albums.isEmpty || state.value == null) return;
