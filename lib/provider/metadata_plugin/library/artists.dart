...
class MetadataPluginSavedArtistNotifier
    extends PaginatedAsyncNotifier<ExtisFullArtistObject> {
  @override
  Future<ExtisPaginationResponseObject<ExtisFullArtistObject>> fetch(
    int offset,
    int limit,
  ) async {
  ...
  Future<void> addFavorite(List<ExtisFullArtistObject> artists) async {
  ...
  Future<void> removeFavorite(List<ExtisFullArtistObject> artists) async {
    if (artists.isEmpty || state.value == null) return;
...
final metadataPluginSavedArtistsProvider = AsyncNotifierProvider<
    ...
    ExtisPaginationResponseObject<ExtisFullArtistObject>>(
  () => MetadataPluginSavedArtistNotifier(),
);
