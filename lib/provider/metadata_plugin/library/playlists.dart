...
class MetadataPluginSavedPlaylistsNotifier
    extends PaginatedAsyncNotifier<ExtisSimplePlaylistObject> {
  ...
  void updatePlaylist(ExtisSimplePlaylistObject playlist) {
  ...
  Future<void> addFavorite(ExtisSimplePlaylistObject playlist) async {
    if (state.value == null) return;
  ...
  Future<void> removeFavorite(ExtisSimplePlaylistObject playlist) async {
    if (state.value == null) return;
...
final metadataPluginSavedPlaylistsProvider = AsyncNotifierProvider<
    ...
    ExtisPaginationResponseObject<ExtisSimplePlaylistObject>>(
  () => MetadataPluginSavedPlaylistsNotifier(),
);
