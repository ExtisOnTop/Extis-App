...
class ScrobblerNotifier extends AsyncNotifier<Scrobblenaut?> {
  final StreamController<ExtisTrackObject> _scrobbleController =
      StreamController<ExtisTrackObject>.broadcast();
  @override
  build() async {
  ...
  Future<void> love(ExtisTrackObject track) async {
  ...
  Future<void> unlove(ExtisTrackObject track) async {
