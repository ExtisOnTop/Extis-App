...
class ExtisColor extends Color {
  final String name;

  const ExtisColor(super.color, {required this.name});

  const ExtisColor.from(super.value, {required this.name});

  factory ExtisColor.fromString(String string) {
    final slices = string.split(":");
    return ExtisColor(int.parse(slices.last), name: slices.first);
  }
...
final Set<ExtisColor> colorsMap = {
  ExtisColor(Colors.slate.value, name: "slate"),
  ExtisColor(Colors.gray.value, name: "gray"),
  ExtisColor(Colors.zinc.value, name: "zinc"),
  ExtisColor(Colors.neutral.value, name: "neutral"),
  ExtisColor(Colors.stone.value, name: "stone"),
  ExtisColor(Colors.red.value, name: "red"),
  ExtisColor(Colors.orange.value, name: "orange"),
  ExtisColor(Colors.yellow.value, name: "yellow"),
  ExtisColor(Colors.green.value, name: "green"),
  ExtisColor(Colors.blue.value, name: "blue"),
  ExtisColor(Colors.violet.value, name: "violet"),
  ExtisColor(Colors.rose.value, name: "rose"),
};
