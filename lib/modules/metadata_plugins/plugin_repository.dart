...
final validTopics = {
  "extis-metadata-plugin": ("Metadata", ExtisIcons.album),
  "extis-audio-source-plugin": ("Audio Source", ExtisIcons.music),
};
    ...
    return Card(
      child: Column(
        ...
        children: [
          Basic(
            title: Text(
              pluginRepo.name.startsWith("extis-plugin")
                  ? pluginRepo.name
                      .replaceFirst("extis-plugin-", "")
                      .trim()
                      .toCapitalCase()
