...
final validAbilities = {
  PluginAbilities.metadata: ("Metadata", ExtisIcons.album),
  PluginAbilities.audioSource: ("Audio Source", ExtisIcons.music),
};
              ...
              return Basic(
                leading: snapshot.hasData
                    ...
                    : Container(
                        ...
                        child: const Icon(ExtisIcons.plugin),
                      ),
                    ...
                    if (repoUrl != null)
                      Wrap(
                        ...
                        children: [
                          if (isOfficial)
                            PrimaryBadge(
                              leading: const Icon(ExtisIcons.done),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                spacing: 4,
                                children: [
                                  const Icon(ExtisIcons.warning, size: 14),
                                  Text(
                          ...
                          SecondaryBadge(
                            leading: const Icon(ExtisIcons.connect),
                ...
                children: [
                  if (requiresAuth && !isAuthenticated)
                    Row(
                      spacing: 8,
                      children: [
                        const Icon(ExtisIcons.warning, color: Colors.yellow),
                  ...
                  if (hasUpdate)
                    SizedBox(
                      ...
                      child: Basic(
                        leading: const Icon(ExtisIcons.update),
                ...
                children: [
                  if (isDefaultMetadata || isDefaultAudioSource)
                    Consumer(builder: (context, ref, _) {
                      ...
                      return Button(
                        ...
                        leading: const Icon(ExtisIcons.heartFilled),
                  ...
                  if ((isDefaultMetadata || isDefaultAudioSource) &&
                    ...
                    Button.primary(
                      ...
                      leading: const Icon(ExtisIcons.login),
                    ...
                    Button.destructive(
                      ...
                      leading: const Icon(ExtisIcons.logout),
