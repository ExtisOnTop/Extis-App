...
class PlayerQueue extends HookConsumerWidget {
  ...
  final Future<void> Function(ExtisTrackObject track) onJump;
      ...
      children: [
                          ...
                          builder: (context, close) => Column(
                            ...
                            children: [
                              ...
                              ButtonTile(
                                ...
                                leading:
                                    const Icon(ExtisIcons.selectionCheck),
                    ...
                    AppBar(
                      ...
                      trailing: [
                        if (mediaQuery.mdAndUp)
                          ...
                          IconButton.ghost(
                            icon: const Icon(ExtisIcons.filter),
                            onPressed: () {
                        ...
                        if (!isSearching.value) ...[
                          ...
                          Tooltip(
                            ...
                            child: IconButton.outline(
                              icon: const Icon(ExtisIcons.playlistRemove),
                              onPressed: () {
                                onStop();
                                closeDrawer(context);
                              },
                          ...
                          const Gap(5),
                          if (mediaQuery.smAndDown)
                            const BackButton(icon: ExtisIcons.angleDown),
                        ],
                      ],
                    ),
                  const Divider(),
        ...
        Positioned(
          ...
          child: IconButton.secondary(
            icon: const Icon(ExtisIcons.angleDown),
            onPressed: () {
