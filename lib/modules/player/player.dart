...
class PlayerView extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    final isLocalTrack = currentActiveTrack is ExtisLocalTrackObject;
                  ...
                  if (!isLocalTrack)
                    Tooltip(
                      ...
                      child: IconButton.ghost(
                        size: const ButtonSize(1.2),
                        icon: const Icon(ExtisIcons.info),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: OutlineButton(
                          leading: const Icon(ExtisIcons.queue),
                      ...
                      Expanded(
                        child: OutlineButton(
                          leading: const Icon(ExtisIcons.music),
                  ...
                  OutlineBadge(
                    ...
                    leading: const Icon(ExtisIcons.lightningOutlined),
