      ...
      try {
        ...
        if (context.mounted &&
            !ref
                ...
                .hasError) {
          context.router.maybePop<ExtisFullPlaylistObject>(
            await ref
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Button.secondary(
                            leading: const Icon(ExtisIcons.edit),
                            child: Text(
                          ...
                          IconButton.destructive(
                            icon: const Icon(ExtisIcons.trash),
...
class PlaylistCreateDialogButton extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    return Button.secondary(
      leading: const Icon(ExtisIcons.addFilled),
