...
class HomeBrowseSectionItemsPage extends HookConsumerWidget {
  ...
  final ExtisBrowseSectionObject<Object> section;
              ...
              slivers: [
                SliverGrid.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return switch (item) {
                      ExtisFullArtistObject() => ArtistCard(item),
                      ExtisSimplePlaylistObject() => PlaylistCard(item),
                      ExtisSimpleAlbumObject() => AlbumCard(item),
                      _ => throw Exception(
