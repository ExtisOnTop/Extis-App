...
class LocalLibraryPage extends HookConsumerWidget {
  ...
  Future<void> playLocalTracks(
    WidgetRef ref,
    List<ExtisLocalTrackObject> tracks, {
    ExtisLocalTrackObject? currentTrack,
  }) async {
                  ...
                  children: [
                    ...
                    Tooltip(
                      ...
                      child: IconButton.outline(
                        ...
                        icon: const Icon(ExtisIcons.shuffle),
                      ),
                    ),
                    const Gap(5),
                    Tooltip(
                      ...
                      child: IconButton.outline(
                        onPressed: trackSnapshot.asData?.value != null
                            ...
                            : null,
                        enabled: !isPlaylistPlaying,
                        icon: const Icon(ExtisIcons.queueAdd),
                      ),
                    ),
                    const Spacer(),
                    ...
                    const Gap(5),
                    IconButton.outline(
                      icon: const Icon(ExtisIcons.refresh),
                      onPressed: () {
                        ref.invalidate(localTracksProvider);
                      },
                    )
                  ...
                  data: (tracks) {
                    final sortedTracks = useMemoized(() {
                      return ServiceUtils.sortTracks(
                          tracks[location] ?? <ExtisLocalTrackObject>[],
                          sortBy.value);
                    }, [sortBy.value, tracks]);
