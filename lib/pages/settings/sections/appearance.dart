  ...
  Widget build(BuildContext context, ref) {
    ...
    final children = [
      AdaptiveSelectTile<LayoutMode>(
        secondary: const Icon(ExtisIcons.dashboard),
      ...
      AdaptiveSelectTile<ThemeMode>(
        secondary: const Icon(ExtisIcons.darkMode),
      ...
      // ListTile(
      //     leading: const Icon(ExtisIcons.amoled),
      ...
      //     )),
      ListTile(
        leading: const Icon(ExtisIcons.palette),
      ...
      // ListTile(
      //     leading: const Icon(ExtisIcons.colorSync),
