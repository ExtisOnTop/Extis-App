    ...
    return SectionCardWithHeading(
      ...
      children: [
        AdaptiveSelectTile<YoutubeClientEngine>(
          secondary: const Icon(ExtisIcons.engine),
        ...
        if (sourcePresets.presets.isNotEmpty) ...[
          AdaptiveSelectTile(
            secondary: const Icon(ExtisIcons.plugin),
          ...
          AdaptiveSelectTile(
            secondary: const Icon(ExtisIcons.audioQuality),
        ...
        ListTile(
          ...
          leading: const Icon(ExtisIcons.cache),
          trailing: Switch(
        ...
        ListTile(
          leading: const Icon(ExtisIcons.playlistRemove),
          title: Text(context.l10n.blacklist),
          subtitle: Text(context.l10n.blacklist_description),
          onTap: () {
            context.navigateTo(const BlackListRoute());
          },
          trailing: const Icon(ExtisIcons.angleRight),
        ),
        ListTile(
          leading: const Icon(ExtisIcons.normalize),
        ...
        ListTile(
            leading: const Icon(ExtisIcons.repeat),
            ...
            children: [
              Tooltip(
                ...
                child: IconButton.outline(
                  icon: const Icon(ExtisIcons.edit),
