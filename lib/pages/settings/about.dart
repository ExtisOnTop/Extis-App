...
@RoutePage()
class AboutExtisPage extends HookConsumerWidget {
  static const name = "about";

  const AboutExtisPage({super.key});
      ...
      child: Scaffold(
        headers: [
          TitleBar(
            ...
            title: Text(context.l10n.about_extis),
          )
        ],
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: [
                Assets.branding.extisLogoPng.image(
                  height: 200,
                  width: 200,
                ),
                Center(
                  child: Column(
                    children: [
                      Text(context.l10n.extis_description).semiBold().large(),
                        ...
                        rows: [
                          ...
                          TableRow(
                            cells: [
                              ...
                              const TableCell(
                                child: Hyperlink(
                                  "github.com/KRTirtho/extis",
                                  "https://github.com/KRTirtho/extis",
                                ),
                              ),
                            ],
                          ),
                          TableRow(
                            cells: [
                              ...
                              const TableCell(
                                child: Hyperlink(
                                  "BSD-4-Clause",
                                  "https://raw.githubusercontent.com/KRTirtho/extis/master/LICENSE",
                                ),
                              ),
                            ],
                          ),
