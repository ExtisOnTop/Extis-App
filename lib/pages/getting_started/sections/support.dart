        ...
        children: [
          BlurCard(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    const Icon(ExtisIcons.heartFilled, color: Colors.pink),
                ...
                Column(
                  ...
                  children: [
                    Button(
                      leading: const Icon(ExtisIcons.github),
                    ...
                    if (!Env.hideDonations) ...[
                      const Gap(16),
                      Button(
                        leading: const Icon(ExtisIcons.openCollective),
                        style: ButtonVariance.primary.copyWith(
                            decoration: (context, states, value) {
                          if (states.isNotEmpty) {
                            return ButtonVariance.primary
          ...
          ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                Button.primary(
                  leading: const Icon(ExtisIcons.extensions),
                  onPressed: () async {
