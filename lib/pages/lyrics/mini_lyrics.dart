                    ...
                    Tooltip(
                      ...
                      child: IconButton(
                        ...
                        icon: showLyrics.value
                            ? const Icon(ExtisIcons.lyrics)
                            : const Icon(ExtisIcons.lyricsOff),
                        onPressed: () async {
                    ...
                    Tooltip(
                      ...
                      child: IconButton(
                        ...
                        icon: hoverMode.value
                            ? const Icon(ExtisIcons.hoverOn)
                            : const Icon(ExtisIcons.hoverOff),
                        onPressed: () async {
                          areaActive.value = true;
                ...
                children: [
                  ...
                  Tooltip(
                    tooltip: TooltipContainer(
                        ...
                        .call,
                    child: IconButton.ghost(
                      icon: const Icon(ExtisIcons.maximize),
                      onPressed: () async {
