...
class PaginationProps {
  ...
  final Future<List<ExtisFullTrackObject>> Function() onFetchAll;
...
class TrackPresentationOptions {
  ...
  final List<ExtisFullTrackObject> tracks;
  ...
  const TrackPresentationOptions({
    ...
    this.onHeart,
    this.error,
  }) : assert(collection is ExtisSimpleAlbumObject ||
            collection is ExtisSimplePlaylistObject);

  String get collectionId => collection is ExtisSimpleAlbumObject
      ? (collection as ExtisSimpleAlbumObject).id
      : (collection as ExtisSimplePlaylistObject).id;
