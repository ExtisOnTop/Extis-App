...
class HorizontalPlaybuttonCardView<T> extends HookWidget {
  ...
  HorizontalPlaybuttonCardView({
    ...
    super.key,
          ...
          items.every(
            (item) =>
                item is ExtisSimpleAlbumObject ||
                item is ExtisSimplePlaylistObject ||
                item is ExtisFullArtistObject,
          ),
        );
  ...
  Widget build(BuildContext context) {
    ...
    final isArtist = items.every((s) => s is ExtisFullArtistObject);
                  ...
                  child: items.isEmpty
                      ...
                      : InfiniteList(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return switch (item) {
                              ExtisSimplePlaylistObject() => PlaylistCard(
                                  item as ExtisSimplePlaylistObject),
                              ExtisSimpleAlbumObject() =>
                                AlbumCard(item as ExtisSimpleAlbumObject),
                              ExtisFullArtistObject() =>
                                ArtistCard(item as ExtisFullArtistObject),
