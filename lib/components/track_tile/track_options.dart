...
/// [track] must be a [ExtisFullTrackObject] or [ExtisLocalTrackObject]
class TrackOptions extends HookConsumerWidget {
  final ExtisTrackObject track;
  ...
  const TrackOptions({
    ...
    this.onTapItem,
          ...
          "Track must be a ExtisFullTrackObject, ExtisLocalTrackObject",
        );
  ...
  Widget build(BuildContext context, ref) {
    ...
    final isLocalTrack = track is ExtisLocalTrackObject;
      ...
      children: [
        if (isLocalTrack)
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.trash),
        ...
        if (mediaQuery.smAndDown && !isLocalTrack)
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.album),
            title: Column(
              mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
        ...
        if (!isInQueue) ...[
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.queueAdd),
          ...
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.lightning),
          ...
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.queueRemove),
        ...
        if (isAuthenticated && !isLocalTrack)
          ButtonTile(
            ...
            leading: isLiked
                ? const Icon(
                    ExtisIcons.heartFilled,
                    color: Colors.pink,
                  )
                : const Icon(ExtisIcons.heart),
            title: Text(
              isLiked
        ...
        if (isAuthenticated && !isLocalTrack) ...[
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.radio),
          ...
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.playlistAdd),
        ...
        if (userPlaylist && isAuthenticated && !isLocalTrack)
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.removeFilled),
        ...
        if (!isLocalTrack)
          ButtonTile(
            ...
            leading: isInDownloadQueue
                ...
                : const Icon(ExtisIcons.download),
        ...
        if (!isLocalTrack)
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.share),
        ...
        if (!isLocalTrack)
          ButtonTile(
            ...
            leading: const Icon(ExtisIcons.info),
