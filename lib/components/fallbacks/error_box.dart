      ...
      child: Padding(
        ...
        child: Card(
          child: Column(
            ...
            children: [
              Basic(
                leading: const Icon(ExtisIcons.error),
                contentSpacing: 8,
              ...
              Row(
                ...
                children: [
                  Button.text(
                    leading: const Icon(ExtisIcons.logs),
                    onPressed: () {
                      showDialog(
                        context: context,
                        builder: (context) {
                                ...
                                HookBuilder(builder: (context) {
                                  ...
                                  return Button.ghost(
                                    leading: copied.value
                                        ? const Icon(ExtisIcons.done)
                                        : const Icon(ExtisIcons.clipboard),
                  ...
                  if (onRetry != null)
                    Button.text(
                      leading: const Icon(ExtisIcons.refresh),
                      onPressed: onRetry,
