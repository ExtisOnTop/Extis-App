...
@freezed
class ExtisImageObject with _$ExtisImageObject {
  factory ExtisImageObject({
    required String url,
    int? width,
    int? height,
  }) = _ExtisImageObject;

  factory ExtisImageObject.fromJson(Map<String, dynamic> json) =>
      _$ExtisImageObjectFromJson(json);
}
...
extension ExtisImageExtensions on List<ExtisImageObject>? {
