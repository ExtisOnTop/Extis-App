...
abstract class ServiceUtils {
  ...
  static DateTime parseSpotifyAlbumDate(ExtisFullAlbumObject? album) {
    if (album == null) {
  ...
  static List<T> sortTracks<T extends ExtisTrackObject>(
  ...
  static Future<void> checkForUpdates(
    ...
    if (Env.releaseChannel == ReleaseChannel.nightly) {
      final value = await globalDio.getUri(
        Uri.parse(
          "https://api.github.com/repos/KRTirtho/extis/actions/workflows/extis-release-binary.yml/runs?status=success&per_page=1",
        ),
        options: Options(
          responseType: ResponseType.json,
        ),
      ...
      final value = await globalDio.getUri(
        Uri.parse(
          "https://api.github.com/repos/KRTirtho/extis/releases/latest",
        ),
      );
