...
/// generated route for
/// [_i1.AboutExtisPage]
class AboutExtisRoute extends _i41.PageRouteInfo<void> {
  const AboutExtisRoute({List<_i41.PageRouteInfo>? children})
    : super(AboutExtisRoute.name, initialChildren: children);

  static const String name = 'AboutExtisRoute';

  static _i41.PageInfo page = _i41.PageInfo(
    name,
    builder: (data) {
      return const _i1.AboutExtisPage();
    },
  );
}
...
class AlbumRoute extends _i41.PageRouteInfo<AlbumRouteArgs> {
  AlbumRoute({
    _i42.Key? key,
    required String id,
    required _i43.ExtisSimpleAlbumObject album,
...
class AlbumRouteArgs {
  ...
  final _i43.ExtisSimpleAlbumObject album;
...
class HomeBrowseSectionItemsRoute
  ...
  HomeBrowseSectionItemsRoute({
    ...
    required _i43.ExtisBrowseSectionObject<Object> section,
    List<_i41.PageRouteInfo>? children,
  }) : super(
...
class HomeBrowseSectionItemsRouteArgs {
  ...
  final _i43.ExtisBrowseSectionObject<Object> section;
...
class LikedPlaylistRoute extends _i41.PageRouteInfo<LikedPlaylistRouteArgs> {
  LikedPlaylistRoute({
    _i42.Key? key,
    required _i43.ExtisSimplePlaylistObject playlist,
    List<_i41.PageRouteInfo>? children,
  }) : super(
...
class LikedPlaylistRouteArgs {
  ...
  final _i43.ExtisSimplePlaylistObject playlist;
