...
class $AssetsBrandingGen {
  ...
  /// File path: assets/branding/extis-logo-light.png
  AssetGenImage get extisLogoLight =>
      const AssetGenImage('assets/branding/extis-logo-light.png');

  /// File path: assets/branding/extis-logo.ico
  String get extisLogoIco => 'assets/branding/extis-logo.ico';

  /// File path: assets/branding/extis-logo.png
  AssetGenImage get extisLogoPng =>
      const AssetGenImage('assets/branding/extis-logo.png');

  /// List of all assets
  List<dynamic> get values =>
      [extisLogoLight, extisLogoIco, extisLogoPng];
}
...
class $AssetsPluginsGen {
  ...
  /// Directory path: assets/plugins/extis-plugin-musicbrainz-listenbrainz
  $AssetsPluginsExtisPluginMusicbrainzListenbrainzGen
      get extisPluginMusicbrainzListenbrainz =>
          const $AssetsPluginsExtisPluginMusicbrainzListenbrainzGen();

  /// Directory path: assets/plugins/extis-plugin-youtube-audio
  $AssetsPluginsExtisPluginYoutubeAudioGen get extisPluginYoutubeAudio =>
      const $AssetsPluginsExtisPluginYoutubeAudioGen();
}
...
class $AssetsPluginsExtisPluginMusicbrainzListenbrainzGen {
  const $AssetsPluginsExtisPluginMusicbrainzListenbrainzGen();

  /// File path: assets/plugins/extis-plugin-musicbrainz-listenbrainz/plugin.smplug
  String get plugin =>
      'assets/plugins/extis-plugin-musicbrainz-listenbrainz/plugin.smplug';

  /// List of all assets
  List<String> get values => [plugin];
}

class $AssetsPluginsExtisPluginYoutubeAudioGen {
  const $AssetsPluginsExtisPluginYoutubeAudioGen();

  /// File path: assets/plugins/extis-plugin-youtube-audio/plugin.smplug
  String get plugin =>
      'assets/plugins/extis-plugin-youtube-audio/plugin.smplug';
