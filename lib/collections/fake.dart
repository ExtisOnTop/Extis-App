...
abstract class FakeData {
  static final ExtisImageObject image = ExtisImageObject(
    height: 100,
    width: 100,
    url: "https://dummyimage.com/100x100/cfcfcf/cfcfcf.jpg",
  );

  static final ExtisFullArtistObject artist = ExtisFullArtistObject(
    id: "1",
    name: "What an artist",
  ...
  static final ExtisFullAlbumObject album = ExtisFullAlbumObject(
    id: "1",
    name: "A good album",
    externalUri: "https://example.com",
  ...
  static final ExtisSimpleArtistObject artistSimple =
  ...
  static final ExtisSimpleAlbumObject albumSimple = ExtisSimpleAlbumObject(
    albumType: ExtisAlbumType.album,
    artists: [],
    externalUri: "https://example.com",
    id: "1",
  ...
  static final ExtisFullTrackObject track = ExtisTrackObject.full(
    id: "1",
    name: "A good track",
    externalUri: "https://example.com",
    album: albumSimple,
    ...
    isrc: "USUM72112345",
    explicit: false,
  ) as ExtisFullTrackObject;

  static final ExtisUserObject user = ExtisUserObject(
    id: "1",
    name: "User Name",
    externalUri: "https://example.com",
    images: [image],
  ...
  static final ExtisFullPlaylistObject playlist = ExtisFullPlaylistObject(
      id: "1",
  ...
  static final ExtisSimplePlaylistObject playlistSimple =
  ...
  static final ExtisBrowseSectionObject browseSection =
      ExtisBrowseSectionObject(
          id: "section-id",
