<div align="center">
  <img width="600" src="assets/branding/extis_banner.png" alt="Extis Logo">
...
<a href="https://extis.krtirtho.dev"><img alt="Visit the website" height="56" src="https://cdn.jsdelivr.net/npm/@intergrav/devins-badges@3/assets/cozy/documentation/website_vector.svg"></a>
...
<a href="https://opencollective.com/extis"><img src="https://opencollective.com/extis/donate/button.png?color=blue" alt="Donate to our Open Collective" height="45"></a>

---

![Extis Desktop](assets/branding/extis-screenshot.png)

![Extis Mobile](assets/branding/mobile-screenshots/combined.jpg)
...
This handy table lists all the methods you can use to install Extis:
...
<table>
  ...
  <tr>
    <td>Windows</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest/download/Extis-windows-x86_64-setup.exe">
  ...
  <tr>
    <td>MacOS</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest/download/Extis-macos-universal.dmg">
  ...
  <tr>
    <td>Android</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest/download/Extis-android-all-arch.apk">
        <img width="220" alt="APK download" src="https://user-images.githubusercontent.com/114044633/223920025-83687de0-e463-4c5d-8122-e06e4bb7d40c.png">
      </a>
      <br/>
      <a href="https://f-droid.org/packages/oss.krtirtho.extis">
  ...
  <tr>
    <td>iOS</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest/download/Extis-iOS.ipa">
  ...
  <tr>
    <td>Flatpak</td>
    <td>
      <p><code>flatpak install com.github.KRTirtho.Extis</code></p>
      <a href="https://flathub.org/apps/details/com.github.KRTirtho.Extis">
  ...
  <tr>
    <td>AppImage</td>
    <td>AppImage's lacking stability led to it's temporary removal. More information at https://github.com/KRTirtho/extis/issues/1082</td>
  </tr>
  <tr>
    <td>Debian/Ubuntu</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest/download/Extis-linux-x86_64.deb">
      ...
      <p>Then run: <code>sudo apt install ./Extis-linux-x86_64.deb</code></p>
    </td>
  </tr>
  <tr>
    <td>Arch/Manjaro</td>
    <td>
      <p>With pamac: <code>sudo pamac install extis-bin</code></p>
      <p>With yay: <code>yay -Sy extis-bin</code></p>
    </td>
  </tr>
  <tr>
    <td>Fedora/OpenSuse</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest/download/Extis-linux-x86_64.rpm">
      ...
      <p>For Fedora: <code>sudo dnf install ./Extis-linux-x86_64.rpm</code></p>
      <p>For OpenSuse: <code>sudo zypper in ./Extis-linux-x86_64.rpm</code></p>
    </td>
  </tr>
  <tr>
    <td>Linux (tarball)</td>
    <td>
      <a href="https://github.com/KRTirtho/extis/releases/latest">
...
brew install --cask extis
  ...
  <tr>
    ...
    <td>
      <p><code>choco install extis</code></p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <p><code>scoop install extis</code></p>
    </td>
  </tr>
  <tr>
    <td>Windows - <a href="https://github.com/microsoft/winget-cli">WinGet</a></td>
    <td>
      <p><code>winget install --id KRTirtho.Extis</code></p>
    </td>
  </tr>
</table>
...
Grab the latest nightly builds of Extis [from the GitHub Releases](https://github.com/KRTirtho/extis/releases/tag/nightly).

## 🕳️ Building from source

<a href="https://github.com/KRTirtho/extis/actions"><img alt="GitHub Workflow Status" src="https://img.shields.io/github/actions/workflow/status/KRTirtho/extis/extis-release-binary.yml?+label=Build%20Status"></a>

You can compile Extis's source code by [following these instructions](CONTRIBUTION.md#your-first-code-contribution).
...
Extis is open source and licensed under the [BSD-4-Clause](/LICENSE) License.
...
1. [hetu_extis_plugin](https://github.com/KRTirtho/hetu_extis_plugin) - A new Flutter package project.
...
<div align="center"><h4>© Copyright Extis 2025</h4></div>
