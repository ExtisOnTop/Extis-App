package oss.krtirtho.extis.glance
...
import oss.krtirtho.extis.MainActivity
import oss.krtirtho.extis.glance.models.Track
import oss.krtirtho.extis.glance.widgets.FlutterAssetImageProvider
import oss.krtirtho.extis.glance.widgets.TrackDetailsView
import oss.krtirtho.extis.glance.widgets.TrackProgress
...
abstract class InteractiveAction(val command: String) : ActionCallback {
    override suspend fun onAction(
        ...
        val backgroundIntent = HomeWidgetBackgroundIntent.getBroadcast(
            context,
            Uri.parse("extis://playback/$command?serverAddress=$serverAddress")
        )
